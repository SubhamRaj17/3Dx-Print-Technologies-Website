...
?>
  <div id="pageContent" style="background-color: beige;border: 10px solid burlywood;"><br />
    <div align="left" style="margin-left:24px;">
      <h2 style="    text-align: center;font-size: 40px;font-family: cursive;color: tomato;">Please Log In To Buy</h2>
      
      <form id="form2" name="form2" method="post" action="user_login.php" style="text-align: center; margin-top: 120px;">
        User Name:<br />
