...
<div align="left" style="margin-left:24px;">
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      <tr>
        <td width="20%" align="right" style="font-size: 20px;font-family: cursive;color: yellowgreen;">User Name</td>
        <td width="80%"><label>
          <input name="name" style="text-align: center;" type="text" id="name" size="40" value=<?php echo $name;?> />
        </label></td>
      </tr>   
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input name="email" style="text-align: center;"  type="text" id="email" size="50" value=<?php echo $email;?> />
        </label></td>
      </tr>
      <tr>
        <td align="right" style="font-size: 20px;font-family: cursive;color: yellowgreen;">Address</td>
        <td><label>
          <textarea name="address" style="text-align: center;"  id="address" cols="64" rows="5"><?php echo $address; ?></textarea>
        </label></td>
      </tr>
      <tr>
        <td width="20%" align="right" style="font-size: 20px;font-family: cursive;color: yellowgreen;">City</td>
        <td width="80%"><label>
          <input name="city" style="text-align: center;"  type="text" id="city" size="20" value=<?php echo $city;?> />
        </label></td>
      </tr>
      <tr>
        <td width="20%" align="right" style="font-size: 20px;font-family: cursive;color: yellowgreen;">State</td>
        <td width="80%"><label>
          <input name="state" style="text-align: center;"  type="text" id="state" size="20" value=<?php echo $state?> />
        </label></td>
      </tr>
      <tr>
        <td align="right" style="font-size: 20px;font-family: cursive;color: yellowgreen;">PinCode</td>
        <td><label>
          <input name="pin" style="text-align: center;"  type="text" id="pin" size="6" value=<?php echo $pin;?> />
        </label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
